...
class StatisticsView extends StatelessWidget {
  ...
  List<Widget> get children {
    // print("哈哈哈 ${logic.records}");
    // print("嘿嘿嘿 ${logic.teamScore}");
    // final newData = logic.records.sort((a, b) => a.tableId - b.tableId);
    final result = <SettlementInfo>[];
    for (final item in logic.records) {
...
class _ScoreBarState extends State<_ScoreBar> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation = Tween<double>(begin: upperHeight * score / 100, end: 0)
        .animate(controller);
