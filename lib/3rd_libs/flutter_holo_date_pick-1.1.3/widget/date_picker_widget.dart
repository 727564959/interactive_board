...
class _DatePickerWidgetState extends State<DatePickerWidget> {
  ...
  FixedExtentScrollController? _yearScrollCtrl,
      _monthScrollCtrl,
      _dayScrollCtrl;
  double get pickerHeight => widget.pickerTheme!.pickerHeight;
  double get itemHeight => widget.pickerTheme!.itemHeight;
    ...
    return Expanded(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          Positioned(
            child: Container(
                margin:  EdgeInsets.only(top: (pickerHeight - itemHeight) / 2),
                child: Row(
