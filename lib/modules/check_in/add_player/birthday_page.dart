...
class BirthdayPage extends StatelessWidget {
  BirthdayPage({Key? key,required this.showInfo,required this.customer,}) : super(key: key);
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  //   ),
                  // ),
                  _AddBirthdayButton(width: 800.w, showInfo: showInfo, customer: customer,),
                  _BackButton(),
                ],
              ),
            ),
    ...
    return GestureDetector(
      ...
      onTap: () async {
        ...
        if(checkingUser.isEmpty) {
          ...
          try {
            Map addUserInfo = await logic.addPlayerFun(Global.tableId, logic.email, testPhone, logic.firstName, logic.lastName, logic.birthdayStr);
            EasyLoading.dismiss(animation: false);
            // 加入到show
            await logic.addPlayerToShow(13, Global.tableId, addUserInfo['userId']);
