...
const fontVariations_ButtomNormal = [
  ...
  FontVariation.weight(844),
  FontVariation.slant(0),
  FontVariation("XOPQ", 125),
  FontVariation("YOPQ", 91),
  FontVariation("XTRA", 551),
  FontVariation("YTUC", 624),
  FontVariation("YTLC", 514),
  FontVariation("YTAS", 720),
  FontVariation("YTDE", -207),
...
const fontVariations_Display2 = [
  ...
  FontVariation("XOPQ", 96),
  FontVariation("YOPQ", 79),
  FontVariation("XTRA", 493),
  FontVariation("YTUC", 628),
  FontVariation("YTLC", 535),
  FontVariation("YTAS", 714),
  FontVariation("YTDE", -203),
  FontVariation("YTFI", 738),
  FontVariation.opticalSize(144),
...
const fontVariations_Display3 = [
  ...
  FontVariation("YOPQ", 79),
  FontVariation("XTRA", 493),
  FontVariation("YTUC", 668),
  FontVariation("YTLC", 535),
  FontVariation("YTAS", 649),
  FontVariation("YTDE", -185),
  FontVariation("YTFI", 738),
  FontVariation.opticalSize(144),
